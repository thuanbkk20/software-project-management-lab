...
namespace MyCompanyName.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20240511025842_updateStudent02")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Classes.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Classes.ClassStudent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LearningProgress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Schedules.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Students.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Students.StudentUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Teachers.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Teachers.TeacherUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Classes.ClassStudent", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Classes.Class", "Class")
                        .WithMany("ClassStudents")
                        .HasForeignKey("ID_class")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyCompanyName.AbpZeroTemplate.Students.Student", "Student")
                        .WithMany("ClassStudents")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Schedules.Schedule", b =>
                {
                    ...
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Teachers.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Students.StudentUser", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Students.Student", "Student")
                        .WithOne("StudentUser")
                        .HasForeignKey("MyCompanyName.AbpZeroTemplate.Students.StudentUser", "ID_student")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Teachers.TeacherUser", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Teachers.Teacher", "Teacher")
                        .WithOne("TeacherUser")
                        .HasForeignKey("MyCompanyName.AbpZeroTemplate.Teachers.TeacherUser", "ID_teacher")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
